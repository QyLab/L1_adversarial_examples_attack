...
class CIFAR_10:
    def __init__(self):
        ...
        data_set_path = '../cifar_10/cifar-10-batches-bin/'

        for i in range(5):
            r, s = load_batch(data_set_path + "data_batch_"+str(i+1)+".bin")
            train_data.extend(r)
        ...
        self.test_data, self.test_labels = load_batch(data_set_path + "test_batch.bin")
